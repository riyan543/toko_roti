...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="py-2 px-3 bg-bakery-light border-bottom d-flex justify-content-between align-items-center">
            <h5 class="mb-0 text-bakery fw-bold">🍞 Toko Roti</h5>
        ...
        <div id="sidebar" class="sidebar-custom shadow-lg">
            <div class="p-3">
                <h4 class="text-bakery fw-bold mb-4">🍞 Toko Roti</h4>
                <ul class="nav flex-column">
                    <li class="nav-item mb-2">
                        <a href="{{ route('beranda') }}" class="nav-link text-bakery-dark fw-semibold">
                            🏠 Beranda
                        </a>
                    </li>
                    <li class="nav-item mb-2">
                        <a href="{{ route('checkout.view') }}" class="nav-link text-bakery-dark fw-semibold">
                            🛒 Keranjang
                        </a>
                    </li>
                    <li class="nav-item mb-2">
                        <a href="{{ route('profile.edit') }}" class="nav-link text-bakery-dark fw-semibold">
                            👤 Profil
                        </a>
                    </li>
        ...
        <div class="col-12 py-5 px-4">
            <h2 class="fw-bold text-bakery mb-4">🥖 Pilihan Roti Khas Kami</h2>
